...
<head>
    ...
    <title>Pembayaran SPP - History Pembayaran Siswa</title>
                        ...
                        <div class="col-xl-3">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body d-flex flex-column text-center">
                                    ...
                                    <div>
                                        <h5><?= $_SESSION['ExSPP']['user']['nama'] ?></h5>
                                        <small><?= $_SESSION['ExSPP']['user']['nisn']." / ".$_SESSION['ExSPP']['user']['nis'] ?></small><br>
                                        <small><?= $_SESSION['ExSPP']['user']['tahun'] ?></small><br>
                                        <small><?= $_SESSION['ExSPP']['user']['nama_kelas'] ?></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <?php for($i=0; $i<=11; $i++) { ?>
                                        ...
                                        <div class="col-xl-3 mb-3 bulan-item">
                                            <div class="card shadow border-danger">
                                                <div class="card-body text-center">
                                                    <h6><?= $data['bulan'][$i] ?></h6>
                                                    <p>Rp. <?= number_format($_SESSION['ExSPP']['user']['nominal'], 0, ',', '.') ?></p>
