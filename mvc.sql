...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `addPengguna` (IN `in_username` VARCHAR(25), IN `in_password` VARCHAR(128), IN `in_role` ENUM('admin','petugas','siswa'))   BEGIN
...
(1, '0058241344', '28913', 'Siswa', '123', '089604926399', 1, 3, 1);
